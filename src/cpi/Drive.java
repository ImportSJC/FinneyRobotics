...
public class Drive {
	...
	public Drive(String name){
		...
		if(!sixSimDriveBase){
			...
			//new base
			right1 =  new MotorController(2);
			right2 =  new MotorController(3);
			right3 =  new MotorController(4);
			left1 =  new MotorController(5);
			left2 =  new MotorController(6);
			left3 =  new MotorController(7);
		}
